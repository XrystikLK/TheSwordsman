...
public class Skeleton : Enemy
{
        ...
        : base(startPosition, health: 150, damage: 10, graphicsDevice, player)
    {
        ...
        attackAnimation.Load(content, "Enemy/Skeleton_attack", frameCount: 10, framesPerSec: 10);
        ...
        var walkingAnimation = new AnimatedTexture(Vector2.Zero, 0f, 1f, 0f);
        walkingAnimation.Load(content, "Enemy/Skeleton_Walk", frameCount: 10, framesPerSec: 12);
        
        var hurtAnimation = new AnimatedTexture(Vector2.Zero, 0f, 1f, 0f);
        hurtAnimation.Load(content, "Enemy/Skeleton_Hurt", frameCount: 5, framesPerSec: 10);
        ...
        hitbox = new Rectangle((int)position.X, (int)position.Y, 40, 65);
